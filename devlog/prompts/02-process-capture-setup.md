# Prompt 02 — Process Capture Setup

**Goal**: Establish a lightweight documentation discipline so the article can show the real thinking process, not a polished retrospective.
...
**What it was trying to achieve**: Create a reproducible process log that lets the article show real-time decision-making rather than a cleaned-up narrative written after the fact.
