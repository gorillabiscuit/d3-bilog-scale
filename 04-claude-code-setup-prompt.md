...
Paste this into Claude Code after cloning the repo and dropping AGENTS.md into the root.
...
Create devlog/DEVLOG.md with a first entry:
```
# Development Log

- **[HH:MM]** Project scaffolded: Vite + D3 v7 + Vitest. Three-chart layout with dataset selector. Five test dataset generators with seeded PRNG.
```

## 7. devlog/prompts/

Create devlog/prompts/01-scaffold.md with this prompt text and a one-line note: "Initial project scaffolding with scale-first architecture."
